...
import icon_2 from '../images/2_icon_estro.png';
...
import spironolactone from '../images/spironolactone_gray.png';
...
class Estrogen extends Component {
  ...
  render() {
    ...
    <div className='flex-column' style={{ paddingBottom: '60px' }}>
      ...
      <div className='flex-row'>
        ...
        <div className='flex-tile parallelogram-rev' style={{ backgroundColor: 'lightgrey' }}></div>
      </div>
      ...
      <div className='flex-row'>
        ...
        <div className='flex-row' style={{ margin: '40px 0px' }}>
          ...
          <div className='flex-tile'>
            <div className='flex-row'>
              <div className='arrow-down' style={{ backgroundColor: 'lightgray', marginLeft: '10px' }}></div>
              <div className='med-text' style={{ width: '200px' }}>
                <span style={{color: 'lightgray', fontWeight: 700}}>Anti-androgens</span> 
                <br></br> 
                Reduce testosterone
              </div>
            </div>
      ...
      <div className='container flex-row med-text text-center' style={{width: '500px'}}>
        <p>For those wishing to transition, these drugs are used to <span style={{color: '#fc54ff'}}>elevate</span> estrogen and <span style={{color: 'lightgray'}}>lower</span> testosterone to average female levels.</p>
      </div> 
    ...
    <div className='flex-column' style={{ padding: '60px 0' }}>
      ...
      <div className='flex-row'>
        <div className='large-text text-center' style={{ margin: '0 0 50px 0', width: '500px' }}>Estrogen causes secondary female characteristics to develop, but changes take time</div>
      </div>
    ...
    <div className='flex-column'>
      ...
      <div className='flex-row'>
        <div className='flex-column' style={{ flex: 1, margin: '0 15px', justifyContent: 'start' }}>
          ...
          <div className='small-text text-center flex-tile top30'>Sold as Estrofem, Estragel, Estradot and others</div>
        ...
        <div className='flex-column' style={{ flex: 1, margin: '0 15px', justifyContent: 'start' }}>
          ...
          <div className='small-text text-center flex-tile top30'>Sold as Progynova, Delestrogen and others</div>
        ...
        <div className='flex-column' style={{ flex: 1, margin: '0 15px', justifyContent: 'start' }}>
          ...
          <div className='small-text text-center flex-tile top30'>Sold as Depo-Estradiol and others</div>
    ...
    <div className='flex-column' style={{ paddingBottom: '60px' }}>
      ...
      <div className='flex-row'>
        <table style={{ width: '600px', margin: '20px 0 10px 0' }}>
          ...
          <tbody>
            <tr>
              <td><b>Thromboembolism (detatched blood clot, can cause stroke)</b></td>
